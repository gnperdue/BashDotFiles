...
# TensorFlow 1.6 and some useful parts of the scipy universe
...
export TF_PYTHON_URL=https://storage.googleapis.com/tensorflow/mac/cpu/tensorflow-1.6.0-py3-none-any.whl
